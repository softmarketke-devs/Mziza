...
const sw = {
  ...
  scanner: {
    ...
    clear: 'Ondoa Picha',
    openCamera: 'Fungua Kamera ya Simu',
    closeCamera: 'Funga Kamera',
    takeSnap: 'Piga Picha Sasa',
    switchCamera: 'Geuza Kamera',
    uploadFile: 'Chagua Picha Kutoka Simuni',
    cameraHint: 'Weka ripoti ya mwanafunzi ndani ya mfano ili kusoma madaraja vizuri.',
    cameraError: 'Kamera haikufunguka. Unaweza kuchagua picha kutoka kwenye simu yako.',
...
const en: UiStrings = {
  ...
  scanner: {
    ...
    openCamera: 'Use Live Camera',
    closeCamera: 'Close Camera',
    takeSnap: 'Capture Photo',
    switchCamera: 'Switch Camera',
    uploadFile: 'Select Image File',
    cameraHint: 'Align student report card inside frame for accurate scanning.',
    cameraError: 'Could not start live camera stream. You can upload an image file instead.',
